...
var kobol = (function (_super) {
    __extends(kobol, _super);
    function kobol() {
     ...
     */
    kobol.prototype.validateTask = function (config) {
     ...
     */
    kobol.prototype.task = function (config) {
     ...
     */
    kobol.prototype.start = function (params) {
        var argTask = params.argTask, option = params.option, envKobol = params.envKobol;
        var foundTask;
        var type;
     ...
     */
    kobol.prototype.createEnv = function (env) {
        if (env) {
            process.env[env] = env;
        }
    };
     ...
     */
    kobol.prototype.verifyTypeTask = function (foundTask) {
     ...
     */
    kobol.prototype.initTask = function (task, option) {
     ...
     * @param {object} task - Task found.
     */
    kobol.prototype.initTasks = function (task) {
        var sequential = task.sequential, parallel = task.parallel;
     ...
     */
    kobol.prototype.runDependenciesParallel = function (tasksRun) {
     ...
     */
    kobol.prototype.getTypeTasks = function (sequential, parallel) {
        var type;
        if (sequential) {
     ...
     */
    kobol.prototype.dependenciesTask = function (task) {
     ...
     */
    kobol.prototype.getDependsTasks = function (dependencies) {
        var tasksRun = {};
     ...
     */
    kobol.prototype.runDependenciesSequential = function (tasksRun) {
        var _this = this;
        var task;
        var params;
